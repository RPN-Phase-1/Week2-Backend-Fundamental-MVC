...
switch (command) {
    ...
    case "addPatient": {
        const [id, username, ...penyakit] = argument;
        HospitalController.addPatient(id, username, penyakit);
        break;
    }
    case "updatePatient": {
        const [id, username, ...penyakit] = argument;
        HospitalController.updatePatient(id, username, penyakit);
        break;
    }
    case "deletePatient" : {
        HospitalController.deletePatient(argument[0], argument[1], ...argument);
        break;
    }
    case "logout" : {
