...
switch (command) {
    ...
    case "login":
        ...
        break;
    case "addPatient":
        HospitalController.tambahPasien(argument[0], argument[1], argument.slice(2))
        break;
    case "updatePatient":
        HospitalController.updatePasien(argument[0], argument[1], argument.slice(2))
        break;
    case "deletePatient":
        HospitalController.hapusPasien(argument);
        break;
    case "logout":
        HospitalController.logout(); 
        break;
    case "show":
        HospitalController.showData(argument[0]); 
        break;
    case "findPatientBy":
