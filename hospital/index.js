...
switch (command) {
    ...
    case "addPatient":{
        const [id, nama, ...penyakit] = argument
        HospitalController.addPatient(id, nama, penyakit);
        break;
    }
    case "updatePatient":{
        const [id, nama, ...penyakit] = argument
        HospitalController.updatePatient(id, nama, penyakit);
        break;
    }

    case "deletePatient":{
        const [id, nama] = argument;
        HospitalController.deletePatient(id,nama);
        break;
    }
